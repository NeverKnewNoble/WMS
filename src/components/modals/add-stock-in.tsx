                ...
                <div className="flex shrink-0 items-start justify-between gap-4 border-b border-white/8 px-6 pb-5 pt-6">
                  <div>
                    ...
                    <p className="mt-1 text-xs text-white/50">
                      Log incoming materials with a Goods Received Note.
                    </p>
                  </div>
                  <button
                    type="button"
                ...
                <div className="flex-1 overflow-y-auto px-6 py-6">
                  ...
                  {tab === "Standard form" ? (
                    ...
                    >
                      ...
                      <div>
                        <FieldLabel>Delivery note / waybill</FieldLabel>
                      ...
                      <div>
                        <FieldLabel>Condition on arrival *</FieldLabel>
                        <select
                          className={fieldClass}
                          required
                          defaultValue="Good"
