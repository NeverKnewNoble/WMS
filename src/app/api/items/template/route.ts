...
export const GET = withApi(async () => {
  ...
  const wb = buildTemplateWorkbook({
    ...
    notes: [
      ...
      "2. Required columns: name, categoryCode, unitCode.",
      "3. A serial (e.g. JC-00042) is generated automatically for each item — you don't need a column for it.",
      "4. categoryCode / unitCode must match a value from the 'Categories' / 'Units' tabs.",
      "5. supplierName / manufacturerName are optional. If used, they must match the reference tabs exactly.",
      "6. reorderLevel, minStock, maxStock are numbers (default 0).",
      "7. isMaintenancePart accepts true/false (default false).",
      "8. Save the file as .xlsx and upload it on the Item Registry page.",
    ],
    columns: [
